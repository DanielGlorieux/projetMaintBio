...
public class ListePanneTIController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        listPanne.setCellFactory(cellIntervention -> {
            CellePanneTIController cellTIController = new CellePanneTIController();
            //cellController.setUserId(userId); // Pass userId to the cell controller
            return cellTIController;
        });
    }

    private void loadInterventions() throws SQLException {
        ResultSet resultSet = databaseHandler.getEquipmentWithPanneNonTraite1();
